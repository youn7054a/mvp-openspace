...
- **전광판 QR** (`/admin/board`) — 전광판에 노출할 QR 코드(이미지+설명)를 필요한 만큼 등록 (행사 안내·설문 등)
...
5. 관리자(`/admin`)는 타임테이블 짜기(그리드 빌더)·룸/타임슬롯 생성, 슬롯 닫기/라벨, 주제 숨김/삭제, 배정, 전광판 QR 등록
